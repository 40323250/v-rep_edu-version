...
{ // This is called just once, at the start of V-REP
	...
	simRegisterCustomLuaVariable("simx_opmode_blocking",(boost::lexical_cast<std::string>(int(simx_opmode_blocking))).c_str());	
	simRegisterCustomLuaVariable("simx_opmode_oneshot_wait",(boost::lexical_cast<std::string>(int(simx_opmode_blocking))).c_str());	
